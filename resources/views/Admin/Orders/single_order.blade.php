    ...
    <div class="container">
        <div class="az-content-body">
            <div class="jumbotron">
                ...
                <div class="text-info" style="font-size: 1.1rem;">Shipping Address: {{$checkouts->Address_line}},{{$checkouts->City}}</div>
                <div class="text-info" style="font-size: 1.1rem;">Payment gateway: {{$checkouts->payment_gateway}}</div>
                @endforeach
